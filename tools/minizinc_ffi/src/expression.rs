...
impl MiniZincExpression {
    pub fn expression_id(&self) -> MiniZincExpressionId {
        let id = unsafe { ffi_bindings::expression_get_id(self.0) };
        id.into()
    }

    pub fn is_intlit(&self) -> bool {
        unsafe { ffi_bindings::expression_is_intlit(self.0) }
    }

    pub fn is_floatlit(&self) -> bool {
        unsafe { ffi_bindings::expression_is_floatlit(self.0) }
    }

    pub fn as_floatlit(&self) -> Option<MiniZincFloatLit> {
        let floatlit_ptr = unsafe { ffi_bindings::expression_as_floatlit(self.0) };
    ...
    pub fn is_setlit(&self) -> bool {
        unsafe { ffi_bindings::expression_is_setlit(self.0) }
    }

    pub fn as_setlit(&self) -> Option<MiniZincSetLit> {
        let setlit_ptr = unsafe { ffi_bindings::expression_as_setlit(self.0) };
    ...
    pub fn is_boollit(&self) -> bool {
        unsafe { ffi_bindings::expression_is_boollit(self.0) }
    }

    pub fn as_boollit(&self) -> Option<MiniZincBoolLit> {
        let boollit_ptr = unsafe { ffi_bindings::expression_as_boollit(self.0) };
    ...
    pub fn is_stringlit(&self) -> bool {
        unsafe { ffi_bindings::expression_is_stringlit(self.0) }
    }

    pub fn as_stringlit(&self) -> Option<MiniZincStringLit> {
        let stringlit_ptr = unsafe { ffi_bindings::expression_as_stringlit(self.0) };
    ...
    pub fn is_id(&self) -> bool {
        unsafe { ffi_bindings::expression_is_id(self.0) }
    }

    pub fn as_id(&self) -> Option<MiniZincId> {
        let id_ptr = unsafe { ffi_bindings::expression_as_id(self.0) };
        if id_ptr.is_null() {
            None
        } else {
    ...
    pub fn is_anon_var(&self) -> bool {
        unsafe { ffi_bindings::expression_is_anon_var(self.0) }
    }

    pub fn as_anon_var(&self) -> Option<MiniZincAnonVar> {
        let anon_var_ptr = unsafe { ffi_bindings::expression_as_anon_var(self.0) };
    ...
    pub fn is_arraylit(&self) -> bool {
        unsafe { ffi_bindings::expression_is_arraylit(self.0) }
    }

    pub fn as_arraylit(&self) -> Option<MiniZincArrayLit> {
        let arraylit_ptr = unsafe { ffi_bindings::expression_as_arraylit(self.0) };
