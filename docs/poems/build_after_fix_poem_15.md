...
memes:
- description: My code flows like a river, again, again, again.
  template: Success Kid meme, with a very, very tired expression
- description: When `cargo build` is smooth, but you've seen this river, like, four times now.
  template: Relieved Spongebob meme, with a very, very tired expression
- description: 'Debugging: It''s like river rafting, but the river keeps repeating itself, endlessly.'
  template: Doge meme
poem_body: |-
