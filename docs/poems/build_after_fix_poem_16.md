...
memes:
- description: My code flows like a river, again, again, again, again.
  template: Success Kid meme, with a very, very, very tired expression
- description: When `cargo build` is smooth, but you've seen this river, like, five times now.
  template: Relieved Spongebob meme, with a very, very, very tired expression
- description: 'Debugging: It''s like river rafting, but the river keeps repeating itself, ad nauseam.'
  template: Doge meme
poem_body: |-
