use crate::functions::callbacks::handle_list_item_two_quotes_regex::{handle_list_item_two_quotes_regex, POEM_FUNCTION_METADATA as LIST_ITEM_TWO_QUOTES_METADATA};
use crate::functions::callbacks::handle_list_item_memes_regex::{handle_list_item_memes_regex, POEM_FUNCTION_METADATA as LIST_ITEM_MEMES_METADATA};
...
pub fn register_new_callbacks(registry: &mut PoemFunctionRegistry) {
    registry.insert(LIST_ITEM_TWO_QUOTES_METADATA.regex_entry.callback_function.clone(), (LIST_ITEM_TWO_QUOTES_METADATA, Box::new(handle_list_item_two_quotes_regex)));
    registry.insert(LIST_ITEM_MEMES_METADATA.regex_entry.callback_function.clone(), (LIST_ITEM_MEMES_METADATA, Box::new(handle_list_item_memes_regex)));
